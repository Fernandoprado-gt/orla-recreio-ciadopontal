...
const ApartmentTypes: React.FC = () => {
  const apartmentFeatures = {
    "3-quartos": [
      ...
      "Localização privilegiada a poucos metros da praia"
    ]
  };
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              >
                ...
                <div className="mt-6">
                  <a 
                    href="https://wa.me/5521988384869?text=Olá,%20gostaria%20de%20saber%20mais%20sobre%20os%20apartamentos%20de%203%20quartos%20do%20Orla%20Recreio" 
                    target="_blank" 
