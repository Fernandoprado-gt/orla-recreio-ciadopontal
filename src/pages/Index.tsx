...
const Index = () => {
  return (
    <div className="min-h-screen">
      {/* Header */}
      <header className="bg-white py-4 px-4 sticky top-0 z-40 shadow-sm">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div>
            ...
            <a href="#plantas" className="md:hidden text-orla-blue">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-white hover:text-orla-blue">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><a href="#plantas" className="hover:text-white">Plantas</a></li>
                <li><a href="#lazer" className="hover:text-white">Lazer</a></li>
                <li><a href="#localizacao" className="hover:text-white">Localização</a></li>
                <li><a href="#construtora" className="hover:text-white">Construtora</a></li>
