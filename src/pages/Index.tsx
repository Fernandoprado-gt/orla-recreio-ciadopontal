      ...
      duration: 0.5
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <a href="#lazer" className="text-orla-dark-text hover:text-orla-blue transition-colors">Lazer</a>
            <a href="#localizacao" className="text-orla-dark-text hover:text-orla-blue transition-colors">Localização</a>
            <a href="#construtora" className="text-orla-dark-text hover:text-orla-blue transition-colors">Construtora</a>
            <a href="#faq" className="text-orla-dark-text hover:text-orla-blue transition-colors">FAQ</a>
          </div>
          <div>
            <a href="#cadastro" className="hidden md:inline-block bg-orla-blue text-white px-4 py-2 rounded-md hover:bg-orla-blue/90 transition-colors">
              Cadastre-se
            </a>
            <button className="md:hidden text-orla-blue" aria-label="Menu">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-orla-blue transition-colors" aria-label="Facebook">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                  </svg>
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-orla-blue transition-colors" aria-label="Instagram">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-orla-blue transition-colors" aria-label="YouTube">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><a href="#construtora" className="hover:text-white transition-colors">Construtora</a></li>
